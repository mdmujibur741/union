                    ...
                    <form method="POST" action="{{route('admin.photos.update', $photo->id)}}" enctype="multipart/form-data">
                       ...
                       @method('put')
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$photo->name}}">
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control @error('sequence') is-invalid @enderror" name="sequence"  value="{{$photo->sequence}}" style="width:30%">
                                @error('sequence')
                                <div class="py-3 " style="color:#f00">{{ $message }}</div>
                             @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select name="status" class="form-control @error('status') is-invalid @enderror">
                                    ...
                                    <option value="{{$key}}" @if($photo->status==$key) selected @endif> {{$item}} </option>
                                    @endforeach

                    ...
                    <form method="post" action="{{route('admin.notices.update', $notice->id)}}" enctype="multipart/form-data">
                       ...
                       @method('put')
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="type_id" class="form-control @error('type_id') is-invalid @enderror">
                                                        ...
                                                        <option value="{{$item->id}}" @if($item->id == $notice->type_id) selected @endif> {{$item->name}} </option>
                                                        @endforeach   
                                                </select>
                                                @error('type_id')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control @error('headline') is-invalid @enderror" name="headline" value="{{$notice->headline}}">
                                @error('headline')
                                <div class="py-3" style="color:#f00">{{ $message }}</div>
                             @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control ckeditor @error('details') is-invalid @enderror" name="details"  > {!! $notice->details !!} </textarea>
                                @error('details')
                                <div class="py-3" style="color:#f00">{{ $message }}</div>
                             @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="" type="number" class="form-control @error('sequence') is-invalid @enderror" name="sequence" value="{{$notice->sequence}}" style="width:30%">
                                @error('sequence')
                                <div class="py-3" style="color:#f00">{{ $message }}</div>
                             @enderror
                            </div>

    ...
    <div class="page-header" style="border:none">
        ...
        <div class="col-sm-6 breadcrumb pull-right" style="float:right; text-align:right">
            <a href="" style="color:#fff; margin-right:5px;" class="btn btn-danger btn-sm"><i class="fa fa-times"></i>
                Multiple Delete</a>
            <a href="{{route('admin.shop_tax.create',$id)}}" style="color:#fff; margin-right:0" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add New Tax </a>
        </div>
    </div>
</div>
<div class="row-fluid">

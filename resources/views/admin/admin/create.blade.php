        ...
        <div class="card">
            ...
            <div class="row" style="margin:10px">
                <div class="">
                    ...
                    <form action="{{route('admin.admin.store')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                       @csrf
                        <div class="col-sm-12">
                            <fieldset style="width:100%; height:auto; float:left; margin:20px 5px; padding:10px; text-align:center; border:1px solid #00CC66">
                                ...
                                <div class="col-md-6" style="padding:3px; margin:0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="inputFieldCss @error('name') is-invalid @enderror" name="name" placeholder="Name" >
                                        @error('name')
                                ...
                                <div class="col-md-6" style="padding:3px; margin:0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="inputFieldCss @error('name') is-invalid @enderror" name="contact" placeholder="Contact No" >
                                        @error('name')
                                        <div class="alert  text-center" style="color:#f00">{{ $message }}</div>
                                     @enderror
                                    </div>
                                ...
                                <div class="col-md-6" style="padding:3px; margin:0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="inputFieldCss @error('name') is-invalid @enderror" name="designation" placeholder="Designation">
                                        @error('name')
                                        <div class="alert  text-center" style="color:#f00">{{ $message }}</div>
                                     @enderror
                                    </div>
                                ...
                                <div class="col-md-6" style="padding:3px; margin:0">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="inputFieldCss @error('email') is-invalid @enderror" name="email" placeholder="Email">
                                        @error('email')
                                        <div class="alert text-center " style="color:#f00">{{ $message }}</div>
                                     @enderror
                                    </div>

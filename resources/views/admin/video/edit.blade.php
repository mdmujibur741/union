...
<div class="col-sm-12">
    <div class="page-header" style="border:none">
        ...
        <div class="col-sm-7 breadcrumb pull-right" style="float:right; text-align:right">
            ...
            <a href="" style="color:#fff; margin-right:20px" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create New Blog</a>
        </div>
    </div>
</div>
<div class="row-fluid">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="row" style="margin:10px">
                <form method="post" action="{{route('admin.videos.update', $video->id)}}" class="form-horizontal" enctype="multipart/form-data">
                   @csrf
                   @method('put')
                    ...
                    <div class="col-sm-12" style="margin-bottom:10px;">
                        <div class="col-sm-12">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control ckeditor @error('title') is-invalid @enderror" name="title" value="{{$video->title}}" style="margin-bottom:5px;" />
                                @error('title')
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <input type="text" class="form-control @error('youtube') is-invalid @enderror" name="youtube" value="{{$video->youtube}}" placeholder="YouTube 11 digit code">
                                @error('youtube')
                                <div class="py-3 " style="color:#f00">{{ $message }}</div>
                             @enderror
                            </div>

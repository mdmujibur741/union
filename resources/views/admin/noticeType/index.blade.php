                                    ...
                                    <tr id="tablerow1" class="tablerow odd" role="row">
                                        ...
                                        <td align="right">
                                            ...
                                            <div style="width:50%; float:left">
                                                ...
                                                <a onclick="return confirm('Are you sure you want to delete this item?');"  href="{{route('admin.notice_types.destroy',$item->id)}}" class="btn btn-danger" style="font-size: 12px; float:left; padding:3px 5px"><i class="fa fa-trash"></i>  </a>

...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, h, l) {
                function m(a, f, D, l) { a = { name: b, sender: this, editor: a, data: f, listenerData: h, stop: D, cancel: l, removeListener: r }; return !1 === d.call(g, a) ? !1 : a.data }

                function r() { D.removeListener(b, d) }
                var f = a.call(this, b);
                if (0 > f.getListenerIndex(d)) {
                    ...
                    for (var t = f.length - 1; 0 <= t; t--)
                        if (f[t].priority <= l) return f.splice(t + 1, 0, m), { removeListener: r };
                    f.unshift(m)
                }
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) {
                    ...
                    if (d.test(c)) var p = "\x3c" + l + "\x3e",
                        m = "\x3c/" + l + "\x3e",
                        c = p + c.replace(d, function() { return m + p }) + m
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return (!b || !h.equals(a)) && (!G || !a.equals(G)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) }
            }
            var l = a ? this._.guardRTL : this._.guardLTR;
            u = k ? function(a, b) { return !1 === l(a, b) ? !1 : k(a, b) } : l;
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                                        ...
                                        if (y && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                            ...
                                            if (d.test(J)) q = null;
                                                ...
                                                for (var G = q.$.getElementsByTagName("*"), C = 0, r; r =
                                                    G[C++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) { q = null; break }
                                            q && (A = !!J.length)
                                        } else q = null;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, P, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            B = null,
                            I = function(a) {
                            ...
                            e = function(a) { var b = I(a);!b && a.is && a.is("br") && (P = a); return b };
                        k.guard = I;
                        k = k.lastBackward();
                        m = m || h;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            ...
                            k.evaluator = function(a) { return !E(a) && !K(a) };
            ...
            _find: function(a, b) {
                ...
                if (c && c.find)
                    for (g = c.find(a), p = 0; p < g.count(); p++)
                        if (c = g.getItem(p), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED,
                            h && l && e.push(c);
                return e
            }
        }
    ...
    (function() {
        ...
        function l(a, b) {
            ...
            if (e = a.requiredClasses)
                for (k = b.classes, c = 0; c < e.length; ++c)
                    if (d = e[c], "string" == typeof d) { if (-1 == CKEDITOR.tools.indexOf(k, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(k, d)) return !1;
        ...
        function f(a) {
            var b, c, d, e, k = {},
                q = 1;
            for (a = Z(a); b = a.match(B);)(c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, k["$" + q++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length);
            return k
        }

        function D(a, b) { var c = a.match(I[b]); return c ? Z(c[1]) : null }
        ...
        function z(a, b, e, k) {
            ...
            if (k.doFilter) {
                ...
                if (!a.allAttributes)
                    for (F in g) A[F] || (m.test(F) ? F == (I = F.replace(/^data-cke-saved-/, "")) || A[I] || (delete g[F], B = !0) : (delete g[F], B = !0));
        ...
        function H(a) { if (!a) return !1; if (!0 === a) return !0; var b = x(a); return function(c) { return c in a || b && c.match(b) } }
        ...
        function k(a, b, c) {
            var d = a.name;
            if (G.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
        ...
        function n(a, b) {
            ...
            for (k in d)
                if ("class" == k)
                    for (c = d[k].split(/\s+/), n = a.classes.join("|"); f = c.pop();) { if (-1 == n.indexOf(f)) return !1 } else if (a.attributes[k] != d[k]) return !1;
            for (q in e)
                if (a.styles[q] !=
                    e[q]) return !1;
            return !0
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (e = 0; e < b.length; ++e) k = this.allow(b[e], c, d); return k }
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        ...
                        for (q = 0; q < b.length; ++q) n = b[q], "string" == typeof n ? (n = n.split(/\s*:\s*/), f = n[0], g = null, p = n[1]) : (f = n.check, g = n.left, p = n.right), k || (k = n, k = k.element ? k.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                            k.left.getDefinition().element), g instanceof CKEDITOR.style && (g = A(g)), c.push({ check: f == k ? null : f, left: g, right: "string" == typeof p ? J(p) : p });
                        b = k;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    e = d
                } else d = a.getDefinition(), e = d.styles, n = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = C(e), n.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = { name: d.element, attributes: n, classes: n["class"] ? n["class"].split(/\s+/) : [], styles: e, children: [] };
                        ...
                        z = function(b) {
                            if (a[b]) D(b, !0);
                                ...
                                if (!(1 < e.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function() { if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, t(b, !0) } : (f.$.onload = function() { setTimeout(function() { t(b, !0) }, 0) }, f.$.onerror = function() { t(b, !1) }));
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (f in a) {
                            ...
                            if (!d[f]) {
                                if (l.icons)
                                    for (var z = l.icons.split(","), x = z.length; x--;) CKEDITOR.skin.addIcon(z[x], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + z[x] + ".png");
                                d[f] = 1
                            }
                            if (t)
        ...
        function D(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var f in c) {
                    ...
                    if (l && (m = l.match(q)))
                        for (; l = m.pop();) CKEDITOR.error("editor-plugin-required", { plugin: l.replace(",", ""), requiredBy: f });
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, h, l) {
                ...
                function r() { for (; H.length;) D(H.shift(), v) }
                ...
                x.onTagOpen = function(e, n, f, g) {
                    ...
                    if (a(n)) w.push(n);
                        ...
                        if ("pre" == e) k = !0;
                        else { if ("br" == e && k) { v.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (u = !0) }
                        if ("br" == e) H.push(n);
                        else {
                            for (; !(g = (f = v.name) ? CKEDITOR.dtd[f] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || v.isUnknown || g[e]);)
                                if (v.isOptionalClose) x.onTagClose(f);
                                else if (e in b && f in b) f = v.children, (f = f[f.length - 1]) && "li" == f.name || D(f = new CKEDITOR.htmlParser.element("li"), v), !n.returnPoint && (n.returnPoint = v), v = f;
    ...
    (function() {
        ...
        function d(b, c, d, g) { var h, l; for (h in c)(l = b[h]) || (l = b[h] = new a), l.add(c[h], d, g) }
    ...
    (function() {
                ...
                return function(e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [],
                            ...
                            u, E;
                        if (n)
                            for (q(n, 1) && k.push(n); n;) g(n) && (u = c(n)) && q(u) && ((E = c(u)) && !g(E) ? k.push(u) : (f(y).insertAfter(u), u.remove())), n = n.previous;
        ...
        function D(a) { return a.replace(P, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function x(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function(a, b) { return c && c[b] || "" }) }
        ...
        function p(a, b) {
            ...
            for (var n = 0; n < d.length; n++) a = a.replace(d[n], function(a) { a = a.replace(k, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, e) { return "\x3c" + c + d + "\x3e" + x(z(e), b) + "\x3c/" + c + "\x3e" })
        }
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) { a.data.dataValue.filterChildren(k.dataFilter, !0) }, null, null, 10);
            b.on("toHtml", function(a) {
                a = a.data;
                var b = a.dataValue,
            ...
            b.on("toDataFormat", function(a) { a.data.dataValue.filterChildren(k.htmlFilter, !0) }, null, null, 10);
            b.on("toDataFormat", function(a) {
    ...
    (function() {
        function a(a) {
            ...
            h(b, e.block, n) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), n = new CKEDITOR.dom.walker(e), n.guard = function(a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !n.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
        ...
        function g(a) {
            function b(a) { return function(b, e) { e && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b); if (!(e || !c(b) || a && z(b))) return !1 } }
            ...
            proto: {
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b =
                            this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(x, function(a, b) { return b }));
                        a.setData(b, null, 1)
                    }, this);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup",
                            function(b) { b.data.getKeystroke() in J && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
        ...
        p = function() {
            ...
            function b(c, d) {
                ...
                for (var h = p[h.getName()], y = 0, l = c.getChildren(), A = l.count(), J = -1, m = -1, r = 0, C = e.contains(p.$list); y < A; ++y) e = l.getItem(y), a(e) ? (n = e.getName(), C && n in CKEDITOR.dtd.$list ? q = q.concat(b(e, d)) : (g = !!h[n], "br" != n || !e.data("cke-eol") || y && y != A - 1 || (r = (f = y ? q[y - 1].node : l.getItem(y + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && p.$block[f.getName()]), -1 != J || g || (J = y), g || (m = y), q.push({
                    ...
                    name: n,
                    allowed: g
                }), f = r = 0)) : q.push({ isElement: 0, node: e, allowed: 1 }); - 1 < J && (q[J].firstNotAllowed = 1); - 1 < m && (q[m].lastNotAllowed = 1);
                return q
            }
            ...
            return function(m, C, B, I) {
                ...
                if (!I.checkReadOnly()) {
                    var F = (new CKEDITOR.dom.elementPath(I.startContainer, I.root)).blockLimit ||
                        I.root;
                    m = { type: C, dontFilter: K, editable: m, editor: E, range: I, blockLimit: F, mergeCandidates: [], zombies: [] };
                    C = m.range;
                    I = m.mergeCandidates;
                    var L, t;
                    ...
                    if (L) {
                        ...
                        for (J(C, v); I < C.length; I++) {
                            ...
                            if (x = F.isLineBreak) {
                                ...
                                var U = void 0,
                                    ba = void 0;
                                F.hasBlockSibling ? x = 1 : (U = x.startContainer.getAscendant(p.$block, 1)) && U.is({ div: 1, p: 1 }) ? (ba =
                    ...
                    if (!m.dontMoveCaret) {
                        for (M = e(N); M && a(M) && !M.is(p.$empty);) {
                            if (M.isBlockBoundary()) N.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { T = null; break }
                                T = N.clone();
        ...
        w = function() {
            ...
            return function(d) {
                ...
                f || (f = e);
                f.is("table") ? (d.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), f.remove()) : (f.is({ tbody: 1, thead: 1, tfoot: 1 }) && (f = b(f, "tr", g)), f.is("tr") && (f = b(f, f.getParent().is("thead") ? "th" : "td", g)), (e = f.getBogus()) && e.remove(), d.moveToPosition(f, g ? CKEDITOR.POSITION_AFTER_START :
                    CKEDITOR.POSITION_BEFORE_END))
            }
        }();
        H = {
    ...
    (function() {
        ...
        function l(a, b) { return b ? a.replace(x, function(a, b) { return b ? " " : "" }) : a.replace(z, "") }
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("key", function(a) { if ("wysiwyg" == e.mode) { var b = e.getSelection(); if (b.isFake) { var c = v[a.data.keyCode]; if (c) return c({ editor: e, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
        });
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function() { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = D ? this.document.$.selection : this.document.getWindow().$.getSelection() },
            getType: D ? function() {
                var a = this._.cache;
                ...
                var a = D ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, k = b.duplicate(), h = 0, l = e.length - 1, B = -1, n, m; h <= l;)
                            if (B = Math.floor((h + l) / 2), f = e[B], k.moveToElementText(f), n = k.compareEndPoints("StartToStart", b), 0 < n) l = B - 1;
                            else if (0 > n) h = B + 1;
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && u[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ });
                        ...
                        if (l) this.fake(l);
                            ...
                            if (D) {
                                ...
                                for (x = 0; x < a.length; x++) {
                                    ...
                                    try { t.setEnd(l.endContainer.$, l.endOffset) } catch (B) {
            ...
            removeAllRanges: function() {
                if (this.getType() != CKEDITOR.SELECTION_NONE) {
                    var a = this.getNative();
                    try { a && a[D ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset()
                }
            }
        }
            ...
            if (c.collapsed) f = H(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (t.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    ...
                    if (t.equals(r)) t = null, k = !0;
                        ...
                        if (v && t.data("cke-bookmark")) { t = t.getNextSourceNode(!0); continue }
                        ...
                        if (y)
                            if (A = t.getParent(), y = h, C = g, G = l, !A || !(A.getDtd() || CKEDITOR.dtd.span)[C] && !G || y.parentRule && !y.parentRule(A)) k = !0;
                            else {
                                if (u ||
                ...
                if (m.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!h && (r = m.getName(),
                        ...
                        if (r = !g && "div" == r) {
                            a: {
                                r = m.getChildren();
                                for (var f = 0, D = r.count(); f < D; f++) { var t = r.getItem(f); if (t.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[t.getName()]) { r = !0; break a } }
                                r = !1
                            }
                            r = !r
                        }
        ...
        init: function(d) {
            function r(a, f, c, e, h) {
                ...
                d.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    refresh: function() { d.activeFilter.check(m) || this.setState(CKEDITOR.TRISTATE_DISABLED) },
                    onOpen: function() {
                    ...
                    n = CKEDITOR.tools.addFunction(function(b,
                        ...
                        if ("?" == b) d.openDialog("colordialog", function() {
                            ...
                            if (b) {
                                ...
                                f.childRule = "back" == c ? function(a) { return t(a) } : function(a) {
                                    return !(a.is("a") ||
                ...
                function d(a, c) {
                    ...
                    do {
                        for (p = b(f, c); !p && f.getParent();) {
                            f = f.getParent();
                            if (-1 !== m(h, f.getName())) { l = k = !0; break }
                            p = b(f, c)
                        }
                        if (p && p.getName && -1 !== m(h, p.getName())) { k = !0; break }
                        f = p
            ...
            _applyStylesToListContext: function(a, b, e) {
                ...
                for (g = 0; g < e.length; g++) d = e[g], c = b.createBookmark(), "ol" === d.element || "ul" === d.element ?
                    k(b, { ul: 1, ol: 1 }, function(a) {
                        ...
                        b.applyToObject(a)
                    }, !0) : "li" === d.element ? k(b, "li", function(a) { d.applyToObject(a) }) : CKEDITOR.plugins.copyformatting._applyStylesToTextContext(a, b, [d]), b.moveToBookmark(c)
            },
